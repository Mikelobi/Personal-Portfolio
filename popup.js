...
const span5 = document.getElementsByClassName('close-work5')[0];
const span6 = document.getElementsByClassName('close-work6')[0];
const span7 = document.getElementsByClassName('close-work7')[0];
